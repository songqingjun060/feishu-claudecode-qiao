...
- Download Feishu images and pass local image paths to Claude Code.
...
- Image download and Claude Code local-tool analysis workflow.
...
See [SECURITY.md](SECURITY.md). Never commit real Feishu secrets, `config.toml`, `config.realtest.toml`, runtime data, or logs.
