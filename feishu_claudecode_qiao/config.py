    ...
    for item in data:
        ...
        tools.append(
            LocalToolConfig(
                ...
                health_command=[str(value) for value in item.get("health_command", [])],
                health_interval_seconds=int(item.get("health_interval_seconds", 0)),
                health_startup_delay_seconds=int(item.get("health_startup_delay_seconds", 0)),
                health_timeout_seconds=int(item.get("health_timeout_seconds", 15)),
                refresh_command=[str(value) for value in item.get("refresh_command", [])],
                refresh_timeout_seconds=int(item.get("refresh_timeout_seconds", 150)),
                refresh_cooldown_seconds=int(item.get("refresh_cooldown_seconds", 1800)),
